...
const FeaturedProducts = ({featuredProducts}) => {
    ...
    useEffect(() => {
        ...
        handleResixze()
        window.addEventListener('resize',handleResixze)
        return () => window.removeEventListener('resize',handleResixze)
    },[])
    const nextSlide = ()=>{
  ...
  return (
    <div className="py-12">
        <div className="container mx-auto px-4">
            <h2 className="text-center text-5xl font-bold text-emerald-400 mb-4">Featured</h2>
